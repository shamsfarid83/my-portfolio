function Hero() {
    return (
        <>
            <section className="hero position-relative vh-100 d-flex align-items-center">
                ...
                <div className="container">
                    <div className="content position-relative d-flex flex-column d-flex flex-column align-items-start gap-4">
                        ...
                        <p className="partTwo text-light mb-4">shams farid — frontend engineer who obsesses over <br /> performance, accessibility, and the fine line between a good <br />interface and a great one. 8 years shipping to production.</p>
                        <a href="#work" className="btn btn-dark border rounded-0">
                            VIEW WORK
                        </a> </div>
                </div>
            </section>
